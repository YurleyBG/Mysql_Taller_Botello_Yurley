...
select nombre,valor_presupuesto(presupuesto, gastos) as presupuesto_actual from departamento;

 -- 12. Lista el nombre de los departamentos y el valor del presupuesto actual
-- ordenado de forma ascendente.
select nombre,valor_presupuesto(presupuesto, gastos) as presupuesto_actual from departamento   order by 2 asc;
...
-- nombre.
select nombre, apellido1, apellido2 from empleado order by 2,3,1 asc;
...
-- aquellos que tienen un presupuesto mayor o igual a 150000 euros.
 ...
 select nombre , presupuesto from departamento where presupuesto > 150000 or presupuesto = 150000 ;
...
select * from empleado where apellido2 = 'Moreno' or apellido2 = 'Diaz'; 

-- 34. Lista todos los datos de los empleados cuyo segundo apellido
-- sea Díaz o Moreno. Utilizando el operador IN.
select * from empleado where apellido2 in('Moreno' ,'Diaz');

-- 35. Lista los nombres, apellidos y nif de los empleados que trabajan en el
-- departamento 3.
select nombre, apellido1, apellido2 , nif from empleado  where empleado.id_departamento = 3;
-- 36. Lista los nombres, apellidos y nif de los empleados que trabajan en los
-- departamentos 2, 4 o 5.

select nombre, apellido1, apellido2 , nif from empleado  where empleado.id_departamento in (2,4,5);